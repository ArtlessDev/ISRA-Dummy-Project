...
<body>
    <form id="form1" runat="server">
        <div style="height: 503px; width: 193px; z-index: 1; left: 6px; top: 9px; position: absolute; margin-top: 46px">
            ...
            <asp:DropDownList ID="ddlApllicationType" runat="server" style="z-index: 1; left: 6px; top: 100px; position: absolute; width: 154px; bottom: 374px">
                <asp:ListItem>Any</asp:ListItem>
            </asp:DropDownList>
&nbsp;<asp:Label ID="Label4" runat="server" style="z-index: 1; left: 4px; top: 148px; position: absolute" Text="Course"></asp:Label>
            ...
            <asp:DropDownList ID="ddlSemester0" runat="server" style="z-index: 1; left: 5px; top: 250px; position: absolute; width: 154px; bottom: 224px">
                <asp:ListItem>Any</asp:ListItem>
            </asp:DropDownList>
